...
<script>
	...
	function fNoticeList(currentPage){
		...
		callAjax("/sss/noticeList.do", "post", "text", true, param,resultCallback);
	...
	//function flistGrpCodResult(data, currentPage) {
		function fNoticeListResult(data,currentPage){
		//alert(data);
					...
					<li class="contents">
						...
						<div class="content">
							...
							<p class="conTitle">
								...
								<!-- <span class="fr"> <a
									class="btnType blue" href="javascript:fPopModalComnGrpCod();"
									name="modal"><span>글쓰기</span></a>
								</span> -->
							...
							<span class="fr"> <a class="btnType blue"
								href="javascript:fPopModalComnGrpCod();" name="modal"><span>글쓰기</span></a>
							</span>
